...
using SafeBCryptKeyHandle = Net5.Microsoft.Win32.SafeHandles.SafeBCryptKeyHandle;
    ...
    public static partial class crypt32
    {
            ...
            CertNameStringType strType)
        {
            ...
            fixed (char* ptr = &MemoryMarshal.GetReference(buffer))
            {
                ...
                return new string(buffer.Slice(0, cchCount - 1).ToArray());
            }
        }
        ...
        [DllImport(Libraries.Crypt32, CharSet = CharSet.Unicode, SetLastError = true)]
        public static extern unsafe bool CertGetIntendedKeyUsage(CertEncodingType dwCertEncodingType, CERT_INFO* pCertInfo, out Net5.System.Security.Cryptography.X509Certificates.X509KeyUsageFlags pbKeyUsage, int cbKeyUsage);
